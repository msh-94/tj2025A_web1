package Example.day08._1의존성; // 패키지명
...
class SampleDao1 { void method1(){} } // class end
...
class SampleController3{
    @Autowired // 스프링 컨테이너(저장소)에 등록된 빈(스프링 컨테이너에 저장된 인스턴스) 꺼내서 멤버변수에 주입
    private SampleDao3 sampleDao3; // = new SampleDao3();
    void method2(){ sampleDao3.method1(); }
}// class end
