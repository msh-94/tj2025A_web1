...
/*
    ...
    4. 
        ...
        [생성]
    5. 생성된 앱 클릭 -> 대시보드 접속
    6. 사이드바 메뉴 -> [앱] -> [일반] -> 중간 스크롤 쯤에 '앱 키' 확인 가능
        * JS 카카오지도 사용시 에는 'JavaScript 키' 사용 : 4c6c30f9d661acbde0445ec214b19d76 
    7. '플랫폼' web 주소 등록 -> [web 플랫폼 등록]
        http://localhost:8080
        http://192.168.40.197:8080
        * 추후에 배포단계에서는 실제 존재하는 도메인 또는 클라우드 ip를 등록한다
    8. 사이드바 메뉴 -> [카카오맵] -> 사용 설정 -> 활성화(on)
        * 계정마다 카카오지도 1개만 활성화 가능 *
...
// [4] 여러개 마커 표기하기 , https://apis.map.kakao.com/web/sample/multipleMarkerImage/
const kakaoMap4 = async() => {
    ...
    // 5. 마커 이미지의 이미지 주소입니다 // static -> img 폴더내 이미지 경로
